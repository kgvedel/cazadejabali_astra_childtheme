...
<script>
        ...
        //tetsinggggggg
        // Variables to track touch event
        let startX = 0;
        let startY = 0;
        ...
        function handleTouchEnd(event) {
            ...
            // Check if swipe is horizontal (greater than vertical)
        ...
        destination.addEventListener('touchstart', handleTouchStart);
        destination.addEventListener('touchend', handleTouchEnd);
